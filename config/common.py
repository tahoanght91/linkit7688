...
list_command = [COMMAND_MCC_OPEN_DOOR, COMMAND_MCC_CLOSE_DOOR, COMMAND_MCC_ON_BELL, COMMAND_MCC_OFF_BELL,
                ...
                COMMAND_ACM_AUTO_OFF, COMMAND_ACM_AUTO_ON, COMMAND_ACM_AIRC_1_OFF, COMMAND_ACM_AIRC_1_ON, COMMAND_ACM_AIRC_2_OFF, COMMAND_ACM_FAN_OFF,
                COMMAND_ACM_FAN_ON, COMMAND_ACM_SELF_PROPELLED_OFF, COMMAND_ACM_SELF_PROPELLED_ON, COMMAND_ATS_ELECTRICITY_SUPPLY_OFF,
                COMMAND_ATS_ELECTRICITY_SUPPLY_ON, COMMAND_ATS_GENERATOR_SUPPLY_OFF, COMMAND_ATS_GENERATOR_SUPPLY_ON, COMMAND_ATS_GENERATOR_OFF,
                COMMAND_ATS_GENERATOR_ON, COMMAND_ATS_START_OFF, COMMAND_ATS_START_ON, COMMAND_ATS_SELF_PROPELLED_OFF, COMMAND_ATS_SELF_PROPELLED_ON]