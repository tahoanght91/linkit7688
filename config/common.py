...
list_command = [COMMAND_MCC_OPEN_DOOR, COMMAND_MCC_CLOSE_DOOR, COMMAND_MCC_ON_BELL, COMMAND_MCC_OFF_BELL,
                ...
                COMMAND_MCC_OFF_DOUT_REVERSED_10, COMMAND_MCC_ON_DOUT_REVERSED_10, COMMAND_MCC_OFF_VMB,
                COMMAND_MCC_ON_VMB,
                COMMAND_MCC_OFF_CAM, COMMAND_MCC_ON_CAM, COMMAND_MCC_OFF_VSENS,
                COMMAND_MCC_ON_VSENS,
                ...
                COMMAND_ATS_MAIN_ON, COMMAND_ATS_GEN_ON, COMMAND_ATS_AUTO_ON, COMMAND_ATS_OFF, COMMAND_ATS_STOP_GEN,
                COMMAND_ATS_START_GEN]
