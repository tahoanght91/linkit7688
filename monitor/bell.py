...
def apply():
    ...
    if client_attributes.get('floodState', default_data.floodState):
    ...
    if (not client_attributes.get('smokeState', default_data.smokeState)
            or client_attributes.get('fireState', default_data.fireState)
            or client_attributes.get('floodState', default_data.floodState)
