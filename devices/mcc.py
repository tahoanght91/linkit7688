...
def extract(byte_data):
    ...
    mccDcBat3Temp = bytes_to_int(byte_data[23:25], byteorder=BYTE_ORDER)
    mccDcAccumulatorSate = bytes_to_int(byte_data[25:27], byteorder=BYTE_ORDER)
    mccDcV1 = bytes_to_int(byte_data[27:29], byteorder=BYTE_ORDER)
    mccDcI1 = bytes_to_int(byte_data[29:31], byteorder=BYTE_ORDER)
    mccDcP1 = bytes_to_int(byte_data[31:33], byteorder=BYTE_ORDER)
    mccDcV2 = bytes_to_int(byte_data[33:35], byteorder=BYTE_ORDER)
    mccDcI2 = bytes_to_int(byte_data[35:37], byteorder=BYTE_ORDER)
    mccDcP2 = bytes_to_int(byte_data[37:39], byteorder=BYTE_ORDER)
    mccDcV3 = bytes_to_int(byte_data[39:41], byteorder=BYTE_ORDER)
    mccDcI3 = bytes_to_int(byte_data[41:43], byteorder=BYTE_ORDER)
    mccDcP3 = bytes_to_int(byte_data[43:45], byteorder=BYTE_ORDER)
    mccDcV4 = bytes_to_int(byte_data[45:47], byteorder=BYTE_ORDER)
    mccDcI4 = bytes_to_int(byte_data[47:49], byteorder=BYTE_ORDER)
    mccDcP4 = bytes_to_int(byte_data[49:51], byteorder=BYTE_ORDER)
    mccDcV5 = bytes_to_int(byte_data[51:53], byteorder=BYTE_ORDER)
    mccDcI5 = bytes_to_int(byte_data[53:55], byteorder=BYTE_ORDER)
    mccDcP5 = bytes_to_int(byte_data[55:57], byteorder=BYTE_ORDER)
    mccSystemClock = bytes_to_int(byte_data[57:61], byteorder=BYTE_ORDER)

    #client attributes
    mccRfidConnectState = bytes_to_int(byte_data[61])
    mccDcCabinetSate = bytes_to_int(byte_data[62])
